...
public class LightsTests {
    ...
    public void trianglesAll() {
        ...
        scene2.lights.add(new PointLight(new Color(200, 250, 800), new Point(-40, -25, -90))
                .setKl(0.001).setKq(0.0001));
        scene2.lights.add(new SpotLight(new Color(50, 250, 20), new Point(20, 30, -50), new Vector(-1, 3, -1))
                .setKl(0.001).setKq(0.0001));
        scene2.lights.add(new DirectionalLight(new Color(80, 50, 40), new Vector(-1, -1, -1)));
        scene2.lights.add(new SpotLight(new Color(250, 250, 0), new Point(20, 5, -50), new Vector(20, -50, -90))
                .setKl(0.000001).setKq(0.000000001).setNarrowBeam(80));
    ...
    public void sphereAll() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new PointLight(new Color(255, 255, 255), new Point(90, -100, -130))
                .setKl(0.0005).setKq(0.0000000005));
        scene1.lights.add(new SpotLight(new Color(255, 0, 210), sphereLightPosition, new Vector(6, 4, -4))
                .setKl(0.0007).setKq(0.00007));
        scene1.lights.add(new DirectionalLight(new Color(200, 200, 250), new Vector(-15, 10, 1)));
        scene1.lights.add(new SpotLight(new Color(250,0,0), sphereLightPosition, new Vector(4, 3, -4))
                .setKl(0.001).setKq(0.000004).setNarrowBeam(20));
